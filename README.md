...
**DestockTCG** refuse les requêtes HTTP venant des serveurs GitHub (`403`), tout en répondant normalement depuis une connexion personnelle. Ses 5 entrées tournent donc en **mode navigateur**. Constaté le 22/09/2026 après 105 échecs d'affilée : une règle validée en local ne prouve rien tant qu'un passage GitHub ne l'a pas confirmée.
